...
\acrodef{TF}{Transcription Factor}
...
% \includeonlylecture{bayes,gpintro,Touchscreen,Classification,Clinical}
% \includeonlylecture{Metabolomics}
\begin{document}
